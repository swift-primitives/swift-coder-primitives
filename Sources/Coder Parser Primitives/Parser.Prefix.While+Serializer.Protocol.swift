//
//  Parser.Prefix.While+Serializer.Protocol.swift
//  swift-coder-primitives
//
//  Append emission for the predicate-prefix parser (previously parse-only):
//  the captured prefix is appended verbatim.
//
